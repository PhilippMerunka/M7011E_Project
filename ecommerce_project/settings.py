...
SECRET_KEY = 'django-insecure-c!*-$4k4*iuv)*%cuuu%o)()^l-ate!iap_2k1p9y_wyfzwjpp'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'social_core.pipeline.user.create_user',  # Creates a new user if not already in the database
